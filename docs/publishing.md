...
```html
<div data-pym-src="https://static.startribune.com/news/projects/all/20191231-turnout">Loading...</div>
...
```js
{
  "publish": {
    "default": {
      ...
      "path": "news/projects-staging/all/20191231-turnout/",
      "url": "http://static.startribune.com/news/projects-staging/all/20191231-turnout/"
    },
    "production": {
      "bucket": "static.startribune.com",
      "path": "news/projects/all/20191231-turnout/",
      "url": "http://static.startribune.com/news/projects/all/20191231-turnout/"
    }
  }
}
```
